...
public class ListFormattingSolutions {
    ...
    //
    // This takes fewer lines of code, but is not necessarily more readable — and list.get(n) can be
    // _very_ slow for some kinds of lists. It’s usually better to use a for-each loop when you can.
    //
